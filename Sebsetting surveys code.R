...
Cranbrook_T1=read.csv("Purpose_Surveys__Pre__Cranbrook_Psyc.csv")
Emily_Griffith=read.csv("EmilyGriffithG1.csv")

Emily_Griffith = Emily_Griffith[-1,]
Cranbrook_T1=Cranbrook_T1[-1,]
Reddam_T1=Reddam_T1[-1,]
Mariah=Mariah[-1,]
Online_Purpsoe_Surveys2=Online_Purpsoe_Surveys2[-1,]
DJ_T1=DJ_T1[-1,]
Online_Purpose_Surveys=Online_Purpose_Surveys[-1,]
SB_W1=SB_W1[-1,]
after_school_IG_W1=after_school_IG_W1[-1,]
after_school_CG_W1=after_school_CG_W1[-1,]
