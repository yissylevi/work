...
\usepackage{Sweave}
\begin{document}
\input{APSI_Table_2_2f-concordance}

% Called in the psych package  fa2latex % Called in the psych package  fa(APSI, 2, rotate = "oblimin", fm = "ml") % Called in the psych package  Table 2. Factor analysis OF APSI as One Factor 
