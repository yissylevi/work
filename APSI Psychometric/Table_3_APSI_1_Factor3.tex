...
\usepackage{Sweave}
\begin{document}
\input{Table_3_APSI_1_Factor3-concordance}

% Called in the psych package  fa2latex % Called in the psych package  fa(APSI, 3, rotate = "oblimin", fm = "ml") % Called in the psych package  Table 2. Factor analysis OF APSI as One Factor 
